...
gulp.task('docker-build', shell.task([
  'docker build -t sandy230207/node-gulp:latest ./getting-started-with-kubernetes-se/docker-image-source/container-info/',
  'docker push sandy230207/node-gulp:latest'
]));
